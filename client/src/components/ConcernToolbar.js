    ...
    return (
        ...
        {props.data.status? (
                <>
                    ...
                    <ResolveConcernModal data={props.data} statusToast={props.statusToast} setStatusToast={props.setStatusToast} setTrucks={props.setTbrucks} openResolveModal={props.openResolveModal} setOpenResolveModal={props.setOpenResolveModal}/>
                    <ViewConcernModal data={props.data} statusToast={props.statusToast} setStatusToast={props.setStatusToast} setTrucks={props.setTrucks} openViewModal={props.openViewModal} setOpenViewModal={props.setOpenViewModal}/>
                    <DeleteConcernModal data={props.data} statusToast={props.statusToast} setStatusToast={props.setStatusToast} setTrucks={props.setTrucks} openDeleteModal={props.openDeleteModal} setOpenDeleteModal={props.setOpenDeleteModal}/>
                </>
            ):(
                <>
                <button onClick={()=>props.setOpenViewModal(true)} className="btn btn-primary mx-2"><i className="fa fa-info-circle" aria-hidden="true"></i></button>
