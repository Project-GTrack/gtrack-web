...
const EmployeeCustomToolbar = ({statusToast,setStatusToast,data,selectedRows,displayData,setAccounts}) => {
    ...
    return (
        <div>
            ...
            {displayData[selectedRows.data[0].dataIndex].data[8] === "Active"?(
                <DeleteEmployeeModal statusToast={statusToast} setStatusToast={setStatusToast} setAccounts={setAccounts} data={displayData[selectedRows.data[0].dataIndex].data} openDeleteModal={openDeleteModal} setDeleteModal={setDeleteModal}/>
            ):(
                <ReactivateModal statusToast={statusToast} setStatusToast={setStatusToast} setAccounts={setAccounts} data={displayData[selectedRows.data[0].dataIndex].data} openDeleteModal={openDeleteModal} setDeleteModal={setDeleteModal}/>
            )}
        </div>
    )
}
