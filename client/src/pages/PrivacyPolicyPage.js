...
const PrivacyPolicyPage = () => {
  return (
    <div className='container text-start p-3'>
        ...
        <li>
        <p><strong>Application</strong> means the software program provided by the Company downloaded by You on any electronic device, named GTrack</p>
        </li>
        <li>
        <p><strong>Company</strong> (referred to as either &quot;the Company&quot;, &quot;We&quot;, &quot;Us&quot; or &quot;Our&quot; in this Agreement) refers to GTrack.</p>
        </li>
        <li>
        ...
        <ul>
        <li>By email: rjoliverio18@gmail.com</li>
        </ul>
    </div>
  )
}
